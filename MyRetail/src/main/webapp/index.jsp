...
<div class="card mt-5 ml-2" >
	...
	<form class="form mt-2" action="SearchServlet">
		<div class="form-row ml-2">
	  		<div class="form-group mb-2 col-1">
	   			 <label for="Name" class="col-form-label">Name</label>
	  		</div>
	 		 <div class="form-group mx-sm-3 mb-2 col-2">
	      			<input type="text" class="form-control" id="searchName" placeholder="search" style="border-radius: 20px" name ="search" onkeyup="searchItem()">
	 		 </div>
	 		 <div class="col-1">
